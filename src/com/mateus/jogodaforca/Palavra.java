...
public class Palavra {
	...
	public String toString() {
		...
		for (int i = 0; i < letrasArray.length; i++) {
			...
			// Checa se o caracetere está presente na lista de caracteres encontrados
	 ...
	 * @return true se a letra existir e false se não existir
	 */
	 ...
	 * @return true se acertou e false se não acertou
	 */
